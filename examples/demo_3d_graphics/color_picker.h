...
#define PALLET_X ((tft.width()-4*PALLET_SIZE)/2)
#define PALLET_Y ((tft.height()-3*PALLET_SIZE)/2)
...
void clearDrawing() { 
  tft.masking_off();
  tft.fastFillRect(0,BUTTON_SIZE+1,tft.width(),tft.width()-1,tft.background_color); 
}
