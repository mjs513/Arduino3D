...
Arduino_3D::Arduino_3D(SPIClass *SPIWire, uint8_t _CS, uint8_t _DC, uint8_t _RST, uint8_t _MOSI, uint8_t _SCLK, uint8_t _MISO) : ILI9488_t3(SPIClass *SPIWire, _CS, _DC, _RST, _MOSI, _SCLK, _MISO) 
{
    setColorMap(11);
}
